...
import data_reader_frequency as data_reader
import random
...
parser.add_argument('--data', type=str, default='./data/Wiki-Data/wikipedia-biography-dataset-debug/',help='location of the data corpus')
