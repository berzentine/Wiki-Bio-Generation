...
class Seq2SeqModel(nn.Module):
    ...
    def forward(self, sent, value, field, ppos, pneg, batch_size):
        ...
        decoder_output, decoder_hidden, attn_vectors = self.decoder.forward(input=sent, hidden=encoder_hidden, encoder_hidden=torch.stack(encoder_output, dim=0), input_z=input_z)
