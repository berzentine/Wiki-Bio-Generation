...
parser.add_argument('--epochs', type=float, default=50,help='epochs')
...
model = ConditionedLM(dropout=dropout, vocab_size=vocab_size, embed_size=emb_size, num_layers=num_layers, hidden_size=hidden_size)
if args.cuda:
    model.cuda()
